...
var DatabaseProxy = function(gameAPI) {
    ...
    self.init = function() {
        ...
        console.log("OPENSHIFT_MYSQL_DB_USERNAME:",process.env.OPENSHIFT_MYSQL_DB_USERNAME);
        console.log("OPENSHIFT_MYSQL_DB_PASSWORD:",process.env.OPENSHIFT_MYSQL_DB_PASSWORD);
